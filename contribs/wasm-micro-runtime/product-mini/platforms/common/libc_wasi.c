...
libc_wasi_print_help(void)
{
    ...
    printf("                             --env=\"key1=value1\" "
           "--env=\"key2=value2\"\n");
    printf("  --dir=<dir>              Grant wasi access to the given hostSymbols "
           "directories\n");
    printf("                           to the program, for example:\n");
    printf("                             --dir=<dir1> --dir=<dir2>\n");
    printf("  --map-dir=<guest::hostSymbols>  Grant wasi access to the given hostSymbols "
           "directories\n");
    printf("                           to the program at a specific guest "
           "path, for example:\n");
    printf("                             --map-dir=<guest-path1::hostSymbols-path1> "
           "--map-dir=<guest-path2::hostSymbols-path2>\n");
