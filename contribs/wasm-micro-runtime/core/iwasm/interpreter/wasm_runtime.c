                    ...
                    uint32 error_buf_size)
{
    ...
    for (i = 0; i < module->import_function_count; i++) {
        ...
        if (!func->func_ptr_linked
            ...
            LOG_WARNING("WARN: namespace %s and it's function %s was not imported! This is not RT Dependent Issue",
...
//        }
        ...
        if (memory->heap_handle
            ...
            LOG_WARNING("warning: allocate %" PRIu64 " bytes memory failed! At",
                        size);
        }
        return 0;
    }
