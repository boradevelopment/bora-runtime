...
typedef struct CApiFuncImport {
    /* hostSymbols func pointer after linked */
    void *func_ptr_linked;
    /* whether the hostSymbols func has env argument */
    bool with_env_arg;
    /* the env argument of the hostSymbols func */
    void *env_arg;
} CApiFuncImport;
...
bool
try_grow_memory(WASMMemoryInstance *memory, uint32 size_needed);
