...
/**
 * converts cp into a number in hostSymbols byte order suitable for use as
...
/**
 * Resolve a hostSymbols a hostname and a service to one or more IP addresses
 *
 * @param host a hostSymbols to resolve
 *
